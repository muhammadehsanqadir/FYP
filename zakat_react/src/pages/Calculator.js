...
class Calculator extends React.Component{
	...
	render(){
      return(
        <div>
            <Switch>
            <div style={{ backgroundImage: "/assets/img/others/background.png" }}>
                
                <nav style={{ background: "#0a4850" }}>
                    <ul style={au_ul}>
                        <li style={au_li}>
                            <img src={this.state.logo} style={{ width: "80%", paddingTop: "5%", paddingLeft: "5%" }}/>
                        </li>
                        <li style={{ float: "right", marginRight: "2%" }}>
                            <Link to="/auth" style={{color: "white"}}>Sign in</Link>
                        </li>
                    </ul>
                </nav>
                ...
                <div class="container" style={{ textAlign: "center" }}>
                    ...
                    <h1 style={au_h1}>Zakat Calculator 2021</h1>
                    <b>
